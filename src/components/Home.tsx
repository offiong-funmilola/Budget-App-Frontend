        ...
        <div className="w-full h-full flex justify-between">
          <div className="w-full md:w-2/3 flex items-center justify-center md:justify-start bg-gradient-to-r from-white ... ">
            <div className="w-3/4 md:2/3 lg:w-1/2 pl-5 md:pl-20 flex flex-col gap-6">
              <h3 className="w-full md:w-[80%] lg:w-[60%] font-sans font-bold text-center md:text-start text-4xl">
                Experience a fresh way to{" "}
                <span className="text-purple-900">manage money</span>
              </h3>
              <p className="w-full md:w-[80%] lg:w-[70%] font-sans text-center md:text-start">
                Reach your goal with personalized insights, custom budgets,
                spend tracking and subscription monitoring - all for free
              </p>
              <Link
                to="/signup"
                className="w-32 h-12 bg-purple-900 text-white text-xl font-sans font-semibold flex items-center justify-center self-center md:self-start"
              >
                Sign up
              </Link>
            </div>
